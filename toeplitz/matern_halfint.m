...
%
%  Implementation of the Matern covariance kernel with half-integer
...
% checking if the input smoothness parameter is indeed half-integer
dfn = nu-0.5;
if(~(dfn == round(dfn)))
...
% subfunction required for maternhalfint
